...
class Solution:
    def maxArea(self, height):
        """
        Runtime: 2028 ms, faster than 9.78% of Python3 online submissions for Container With Most Water.
        Memory Usage: 27.5 MB, less than 11.17% of Python3 online submissions for Container With Most Water.
        """
        water = 0
...
if __name__ == "__main__":
    ...
    print(f"My ans is: {result}, Ans = 49\n")
